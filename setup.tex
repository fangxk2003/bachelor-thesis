...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {基于深度学习的膝关节 ACL/MLKI 撕裂后骨与软骨分割及 BML 量化分析研究},
    en / title           = {Deep Learning-Based Bone and Cartilage Segmentation and BML Quantification After Knee ACL Tears and MLKI},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {深度学习，无监督域适应，医学图像分割，膝关节磁共振成像，ACL与MLKI},
    en / keywords        = {deep learning, unsupervised domain adaptation, medical image segmentation, knee MRI, ACL and MLKI},
    %
    % 姓名
    %
    zh / author          = {方行楷},
