...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {基于深度学习的膝关节ACL撕裂后骨与骨髓病变的自动检测和分割},
    en / title           = {Automated Detection and Segmentation of Bone and Bone Marrow Lesions Following Knee ACL Tears Based on Deep Learning},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    zh / keywords        = {深度学习，无监督域适应，医学图像分割，膝关节磁共振成像，创伤机制量化分析},
    en / keywords        = {deep learning, unsupervised domain adaptation, medical image segmentation, knee MRI, trauma mechanism quantitative analysis},
    %
    % 姓名
    %
    zh / author          = {方行楷},
    en / author          = {Xingkai Fang},
    %
    % 学号
    %
    id              = {522031910108},
    ...
    %
    zh / major           = {生物医学工程},
    en / major           = {Biomedical Engineering},
    %
    % 学位
