...
\begin{abstract}[zh]
  ...
  针对上述问题，本文开发了一套无监督/极少监督的深度学习膝关节MRI分割与三维量化分析管线，其中经人工测试集验证的核心分割任务为骨与软骨分割，BML部分主要定位为FSE高信号候选区域的自动检测、候选区域粗分割与体积量化。
...
\begin{abstract}[en]
  ...
  To address these limitations, this thesis proposes an unsupervised/few-shot deep learning pipeline for knee MRI segmentation and 3D quantitative analysis. The core segmentation task validated with manual annotations is bone and cartilage segmentation, whereas the BML component is positioned as automated detection, candidate-region coarse segmentation, and volume quantification of high-signal regions on FSE images.
